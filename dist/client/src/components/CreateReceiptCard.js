...
function CreateReceiptCard({ setOpen, paymentMethod }) {
    ...
    const toPay = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Typography_1.default, Object.assign({ id: "transition-modal-title", variant: "h5", component: "h2" }, { children: ["Amount Due: \u20B1 ", total] })), (0, jsx_runtime_1.jsxs)(Button_1.default, Object.assign({ color: "secondary", variant: "contained", type: "submit", fullWidth: true, onClick: handleSubmit }, { children: ["Pay With GCash \u00A0", (0, jsx_runtime_1.jsx)(Payment_1.default, {})] }))] }));
    const payed = ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(Box_1.default, Object.assign({ sx: { display: "flex", alignItems: "center", mt: 3, mb: 2 } }, { children: (0, jsx_runtime_1.jsxs)(Typography_1.default, Object.assign({ id: "transition-modal-title", variant: "h5", component: "h2" }, { children: [(0, jsx_runtime_1.jsx)(Box_1.default, { sx: { display: "flex", alignItems: "center" } }), (0, jsx_runtime_1.jsx)(Box_1.default, Object.assign({ sx: {
                            color: theme.palette.success.main,
                            justifyContent: "center",
                            display: "flex",
                            alignItems: "center",
                        } }, { children: (0, jsx_runtime_1.jsx)("h3", { children: "Transaction Successful!" }) })), (0, jsx_runtime_1.jsx)(Box_1.default, Object.assign({ sx: { display: "flex", alignItems: "center", mt: 3, mb: 2 } }, { children: (0, jsx_runtime_1.jsx)(Button_1.default, Object.assign({ autoFocus: true, fullWidth: true, color: "secondary", variant: "contained", onClick: (e) => {
                                e.preventDefault();
                                setOpen(false);
                            } }, { children: "close" })) }))] })) })) }));
